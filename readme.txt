...
必要事項を記入し，この文章や，例などの不要な部分を削除し
提出物の中に含めること．適当な幅で適切に改行を入れ
フォーマットを整えること．
...
※1のコマンドを打ちなおした場合，一度自動構成ファイルを無効にしてから
再度有効にする必要がある．
...
また，審査の再に特に見てほしい項目．このプログラムの
売り込みたい点などを説明．完成された作品からは
読み取れないが，最初考えていた方針では上手くいかな
くて苦労した話，それをどのように解決したのかなどの
話も，是非ここに記述して下さい．もしここに書ききれ
ないような場合は，「企画書，設計書，UML」の時と
同じように別のファイルで説明しても良いです．
